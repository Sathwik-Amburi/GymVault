...
router.post(
  "/filter/selected-ranges",
  gymController.filterGymsBySelectedFilters
);
...
router.patch(
  "/edit-subscriptions-discounts",
  validateJwtToken,
  gymController.editGymSubscriptionPrice
);
router.get(
  "/add-permission",
  validateJwtToken,
  gymController.gymFormPermission
);
