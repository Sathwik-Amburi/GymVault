...
const StripeConnect: FC<StripeConnectProps> = (props: any) => {
  ...
  const navigateToOverview = () => {
    props.gymAddPermission
      ? navigate("/gym/add")
      : navigate("/gym/revenue-overview");
  };
          ...
          >
            ...
            >
              ...
              >
                ...
                {activeSubs > 0 ? (
                  <div style={{ color: "darkblue", fontSize: "14px" }}>
                    {activeSubs} active{" "}
                    {activeSubs == 1 ? "subscription" : "subscriptions"}
                  </div>
                ) : (
                  ""
                )}
          ...
          >
            <div style={{ textAlign: "center", margin: "15px" }}>
              ...
              >
                <i
                  ...
                  aria-hidden="true"
                ></i>
                {processing ? "Processing . . . " : "Manage Earnings"}
              </Button>
              <div
                style={{ fontSize: "12px", margin: "11px 3px", color: "grey" }}
              >
                {" "}
                <i>
                  You will be redirected to your Stripe Connect dashboard
                </i>{" "}
              </div>
            </div>
            ...
            <div style={{ textAlign: "center", margin: "15px" }}>
              ...
              >
                {" "}
                <i>
                  You can add discounts to your gym's subscription here
                </i>{" "}
              </div>
            </div>
          </div>
