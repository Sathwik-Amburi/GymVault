...
export default function RevenueTable(props: any) {
  ...
  useEffect(() => {
    ...
    subs.forEach((sub: any) => {
      ...
      sub.optionals.forEach((optional: any) =>
        optionalsNames.push(optional.name)
      );
          ...
          <TableBody>
            {rows.map((row: any) => (
              <StyledTableRow key={row.name}>
                ...
                <StyledTableCell align="left">
                  {toCleanSubscriptionTypeFormat(row.subscriptionType)}
                </StyledTableCell>

                <StyledTableCell align="left">{row.price}</StyledTableCell>
                <StyledTableCell align="left">
                  {row.optionalsNames ? row.optionalsNames : "none"}
                </StyledTableCell>
