...
export default function SearchType({type} : any) {
    ...
    const search = (event: any) => {
        ...
        if (!allCities.includes(city)) {
            ...
            navigate(`/${type=='gyms'?'gyms':'courses'}/search?name=${name}&city=${city}`);
        }
    }
    ...
    return (
        <>
            <div style={{ "display": "flex", "flexDirection": "row", "justifyContent": "center", "margin": "30px 0px 40px 0px" }}>
                ...
                <Button onClick={search} style={{ "marginLeft": "3px", "height": "55px" }} variant="contained" endIcon={<i className="fas fa-search" />}>
                    Search
                </Button>
