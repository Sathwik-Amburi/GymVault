...
export default function FrontPage() {
  ...
  return (
    <Container maxWidth="lg">
      ...
      {/* Hero unit */}
      <Grid container spacing={3} style={{ textAlign: "center", padding: "5em" }}>
        <Grid item xs={12}>
          <img
            src={mainLogo}
            style={{
      ...
      <Grid container spacing={3} maxWidth="lg" style={{ padding: "5em" }}>
        <Grid item md={6} xs={12}>
          ...
          <Typography component="h6" variant="body2" align="left" color="text.primary" gutterBottom>
            Browse our large gym and course catalog, choose the one that matches your exact needs, and
            pay only for what you use. All fully digitally.
          </Typography>
        </Grid>
        <Grid item md={2} xs={4}>
          <i className="fas fa-football" style={{ fontSize: "2em", float: "right", color: "#3B66A5" }} />
      ...
      <Card elevation={3} style={{borderRadius: "20px", margin: "3em"}}>
        <div style={{
          ...
          <Typography variant="body1" color="text.primary" style={{ fontWeight: "bold", marginRight: "1em" }}>
            Show me
          </Typography>
      ...
      <Grid container spacing={3} style={{ paddingTop: "5em" }}>
        <Grid item md={6} xs={12}>
          ...
          <Typography component="h6" variant="body2" align="left" color="text.primary" gutterBottom>
            We have a large network of partners in Germany, so you can find the fitness centre that is closest to you, and that better satisfies your needs.
          </Typography>
        </Grid>
        ...
        <Grid item md={5} xs={12}>
          <Card elevation={3} style={{borderRadius: "20px", padding: "3em"}}>
            <Typography component="h2" variant="h5" align="right" color="text.primary" gutterBottom>
              Happen to own a gym?
            </Typography>
            <Typography component="h6" variant="body2" align="right" color="text.primary" gutterBottom>
